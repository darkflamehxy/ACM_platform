...
public class Problem {
    ...
    private Set<Knowledge> knowledge; /* 关联关系：题目对应的知识点（误删） */


    public Problem() {
    }

    public Problem(Integer id, String name, String description, String input, String output, String sampleInput, String sampleOutput, Integer level, String answer, String proID, OnlineJudge onlineJudge, Set<Knowledge> knowledge) {
        this.id = id;
        this.name = name;
